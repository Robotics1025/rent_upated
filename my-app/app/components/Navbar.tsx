      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden md:flex items-center space-x-4">
            <button className="px-5 py-2 text-blue-600 hover:text-blue-700 transition font-semibold">
              Login
            </button>
            <button className="px-6 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-lg hover:from-blue-700 hover:to-indigo-700 transition shadow-lg font-semibold">
              Get Started Free
            </button>
          </div>
      ...
      {isMenuOpen && (
        <div className="md:hidden bg-white border-t">
          <div className="px-4 py-4 space-y-3">
            ...
            <button className="w-full px-5 py-2 text-blue-600 border border-blue-600 rounded-lg font-semibold">
              Login
            </button>
            <button className="w-full px-6 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-lg font-semibold">
              Get Started Free
            </button>
          </div>
        </div>
