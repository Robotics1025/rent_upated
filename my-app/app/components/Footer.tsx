        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center space-x-2 mb-6">
              ...
              <h3 className="text-2xl font-bold">RentManager Pro</h3>
            </div>
            <p className="text-gray-400 mb-6 leading-relaxed">
              The leading property and rent management platform trusted by thousands of property managers worldwide. 
              Streamline operations, maximize revenue, and deliver exceptional tenant experiences.
            </p>
        ...
        <div className="mt-12 pt-12 border-t border-gray-800">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="flex gap-3">
              ...
              />
              <button className="px-6 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 rounded-lg font-semibold transition">
                Subscribe
              </button>
            </div>
          </div>
