...
export default function WhatsAppWidget() {
  ...
  const phoneNumber = "2560701648706" // EazyRent WhatsApp number
  ...
  return (
    <>
      ...
      {showScrollTop && (
        <button
          onClick={scrollToTop}
          className="fixed bottom-6 right-20 z-50 bg-emerald-600 text-white p-3 rounded-full shadow-lg hover:bg-emerald-700 transition-all duration-300 hover:scale-110 animate-bounce"
      ...
      {isOpen && (
        <div className="fixed bottom-24 right-6 z-50 bg-white rounded-lg shadow-xl w-80 overflow-hidden">
          <div className="bg-emerald-600 text-white p-4">
            <h3 className="font-bold text-lg">Chat with EazyRent</h3>
          ...
          <form onSubmit={handleSubmit} className="p-4 space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                required
                className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-emerald-500"
                placeholder="Hi, I'd like to inquire about property management..."
              ></textarea>
            </div>
